...
import { Pizza, Lock, Mail, User, Phone, ArrowRight, Loader2, AlertCircle, MapPin } from 'lucide-react';
    ...
    <div className="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 bg-gray-50">
      <div className="max-w-md w-full bg-white p-8 sm:p-10 rounded-3xl soft-shadow border border-gray-100 space-y-6">
        <div className="text-center">
          ...
          <p className="text-xs text-gray-500 mt-1">Get fast wood-fired pizza delivery right to your door</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <label className="text-xs font-bold text-gray-700 block mb-1">Delivery Address (Optional)</label>
            <div className="relative">
